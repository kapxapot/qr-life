    ...
    <div className="grid gap-1" style={boardStyle}>
      {matrixCells.map(({ delay, isActive, key }) => (
        <span
          key={key}
          className={[
            "aspect-square rounded-lg transition-transform duration-300",
            variant === "qr"
              ? isActive
                ? "bg-white shadow-[0_0_10px_rgba(255,255,255,0.2)]"
                : "bg-slate-900/80"
              : isActive
                ? "animate-pulse bg-linear-to-br from-cyan-300 via-emerald-300 to-fuchsia-400 shadow-[0_0_18px_rgba(74,222,128,0.42)] animation-duration-[2.8s]"
...
export default function ReferencePage() {
  return (
    <main className="relative isolate min-h-screen overflow-hidden">
      <div className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_top_left,rgba(45,212,191,0.22),transparent_28%),radial-gradient(circle_at_top_right,rgba(217,70,239,0.18),transparent_26%),radial-gradient(circle_at_80%_80%,rgba(249,115,22,0.18),transparent_22%),linear-gradient(180deg,#050816_0%,#070c19_48%,#04050d_100%)]" />
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(rgba(255,255,255,0.045)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.045)_1px,transparent_1px)] bg-size-[72px_72px] mask-[radial-gradient(circle_at_center,black,transparent_82%)]" />
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col justify-center px-6 py-10 sm:px-8 lg:px-12">
        <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <section className="relative mx-auto w-full max-w-120">
            <div className="relative w-full overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/70 p-4 shadow-[0_42px_120px_-32px_rgba(56,189,248,0.38)] backdrop-blur-2xl">
              <div className="rounded-[1.7rem] border border-white/10 bg-[linear-gradient(180deg,rgba(11,19,37,0.98),rgba(5,8,17,0.98))] p-5">
                ...
                <div className="relative mt-5 overflow-hidden rounded-[1.5rem] border border-cyan-300/15 bg-[radial-gradient(circle_at_top,rgba(8,47,73,0.36),transparent_48%),linear-gradient(180deg,rgba(15,23,42,0.98),rgba(2,6,23,0.98))] px-5 py-6">
                  ...
                  <div className="pointer-events-none absolute inset-x-[12%] top-1/2 h-px -translate-y-1/2 animate-pulse bg-linear-to-r from-transparent via-cyan-200 to-transparent shadow-[0_0_18px_rgba(103,232,249,0.95)] animation-duration-[1.8s]" />
                ...
                <div className="my-5 flex items-center gap-3 text-sm text-slate-300">
                  <div className="h-px flex-1 bg-linear-to-r from-transparent via-cyan-300/60 to-transparent" />
                  <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1 uppercase tracking-[0.2em] text-cyan-100/80">
                    mapped into life
                  </span>
                  <div className="h-px flex-1 bg-linear-to-r from-transparent via-fuchsia-300/60 to-transparent" />
                </div>
